...
#ifndef _TAO_PIDL_POLLABLEC_PTXX0X_H_
#define _TAO_PIDL_POLLABLEC_PTXX0X_H_
...
#define _CORBA_POLLABLESET__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<PollableSet> PollableSet_var;
  typedef TAO_Objref_Out_T<PollableSet> PollableSet_out;
...
#define _CORBA_POLLABLE__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<Pollable> Pollable_var;
  typedef TAO_Objref_Out_T<Pollable> Pollable_out;
...
#define _CORBA_DIIPOLLABLE__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<DIIPollable> DIIPollable_var;
  typedef TAO_Objref_Out_T<DIIPollable> DIIPollable_out;
