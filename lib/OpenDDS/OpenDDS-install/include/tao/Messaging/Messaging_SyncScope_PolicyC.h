...
#ifndef _TAO_PIDL_MESSAGING_SYNCSCOPE_POLICYC_00P70P_H_
#define _TAO_PIDL_MESSAGING_SYNCSCOPE_POLICYC_00P70P_H_
...
#define _MESSAGING_SYNCSCOPEPOLICY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<SyncScopePolicy> SyncScopePolicy_var;
  typedef TAO_Objref_Out_T<SyncScopePolicy> SyncScopePolicy_out;
