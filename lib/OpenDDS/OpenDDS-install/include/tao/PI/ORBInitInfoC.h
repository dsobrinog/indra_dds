...
#ifndef _TAO_PIDL_ORBINITINFOC_PXAH0P_H_
#define _TAO_PIDL_ORBINITINFOC_PXAH0P_H_
...
#define _PORTABLEINTERCEPTOR_SERVERREQUESTINTERCEPTOR__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ServerRequestInterceptor> ServerRequestInterceptor_var;
  typedef TAO_Objref_Out_T<ServerRequestInterceptor> ServerRequestInterceptor_out;
...
#define _PORTABLEINTERCEPTOR_IORINTERCEPTOR__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<IORInterceptor> IORInterceptor_var;
  typedef TAO_Objref_Out_T<IORInterceptor> IORInterceptor_out;
...
#define _PORTABLEINTERCEPTOR_ORBINITINFO__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ORBInitInfo> ORBInitInfo_var;
  typedef TAO_Objref_Out_T<ORBInitInfo> ORBInitInfo_out;
...
#define _PORTABLEINTERCEPTOR_ORBINITINFO_3_1__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<ORBInitInfo_3_1> ORBInitInfo_3_1_var;
  typedef TAO_Objref_Out_T<ORBInitInfo_3_1> ORBInitInfo_3_1_out;
