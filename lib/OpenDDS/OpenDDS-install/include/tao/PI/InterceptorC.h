...
#ifndef _TAO_PIDL_INTERCEPTORC_0HXHDX_H_
#define _TAO_PIDL_INTERCEPTORC_0HXHDX_H_
...
#define _PORTABLEINTERCEPTOR_INTERCEPTOR__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<Interceptor> Interceptor_var;
  typedef TAO_Objref_Out_T<Interceptor> Interceptor_out;
