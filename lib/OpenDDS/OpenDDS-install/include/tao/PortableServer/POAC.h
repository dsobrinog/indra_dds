...
#ifndef _TAO_PIDL_POAC_F0XPPP_H_
#define _TAO_PIDL_POAC_F0XPPP_H_
...
#define _PORTABLESERVER_POAMANAGERFACTORY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<POAManagerFactory> POAManagerFactory_var;
  typedef TAO_Objref_Out_T<POAManagerFactory> POAManagerFactory_out;
