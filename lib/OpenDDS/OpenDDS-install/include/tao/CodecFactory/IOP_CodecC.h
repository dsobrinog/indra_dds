...
#ifndef _TAO_PIDL_IOP_CODECC_0PPPPX_H_
#define _TAO_PIDL_IOP_CODECC_0PPPPX_H_
...
#define _IOP_CODEC__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<Codec> Codec_var;
  typedef TAO_Objref_Out_T<Codec> Codec_out;
...
#define _IOP_CODECFACTORY__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<CodecFactory> CodecFactory_var;
  typedef TAO_Objref_Out_T<CodecFactory> CodecFactory_out;
