...
#ifndef _TAO_IDL_DDSDYNAMICDATAC_P4KP84_H_
#define _TAO_IDL_DDSDYNAMICDATAC_P4KP84_H_
...
#define _DDS_DYNAMICTYPE__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<DynamicType> DynamicType_var;
  typedef TAO_Objref_Out_T<DynamicType> DynamicType_out;
  

#endif /* end #if !defined */
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_valuetype.cpp:565
...
#define _DDS_INCLUDEPATHSEQ_CH_
  ...
  typedef ::TAO_VarSeq_Var_T<IncludePathSeq> IncludePathSeq_var;
  typedef ::TAO_Seq_Out_T<IncludePathSeq> IncludePathSeq_out;
...
#define _DDS_TYPEOBJECT__VAR_OUT_CH_
  ...
  typedef TAO_Objref_Var_T<TypeObject> TypeObject_var;
  typedef TAO_Objref_Out_T<TypeObject> TypeObject_out;
...
#define _DDS_BOUNDSEQ_CH_
  ...
  class BoundSeq;
  typedef ::TAO_FixedSeq_Var_T<BoundSeq> BoundSeq_var;
  typedef ::TAO_Seq_Out_T<BoundSeq> BoundSeq_out;
  ...
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_map/map_ch.cpp:46

  

#if !defined (_DDS_PARAMETERS_CH_)
#define _DDS_PARAMETERS_CH_

  typedef std::map< ::TAO::String_Manager, ::TAO::String_Manager> Parameters;
...
#define _DDS_ANNOTATIONDESCRIPTOR__VAR_OUT_CH_
...
#endif /* end #if !defined */
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/valuetype_ch.cpp:49
  ...
  public:
    // TAO_IDL - Generated from
    // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/field_ch.cpp:229
  ...
  public:
    // TAO_IDL - Generated from
    // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/valuetype_ch.cpp:397
  ...
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/valuetype_ch.cpp:236
...
public:
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/field_ch.cpp:598
...
public:
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/field_ch.cpp:451
...
public:
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/field_ch.cpp:524
...
public:
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/field_ch.cpp:171
...
typedef ::TAO_FixedSeq_Var_T<UnionCaseLabelSeq> UnionCaseLabelSeq_var;
typedef ::TAO_Seq_Out_T<UnionCaseLabelSeq> UnionCaseLabelSeq_out;
...
typedef TAO_Objref_Var_T<DynamicTypeMember> DynamicTypeMember_var;
typedef TAO_Objref_Out_T<DynamicTypeMember> DynamicTypeMember_out;
...
#if !defined (_DDS_DYNAMICTYPEMEMBERSBYNAME_CH_)
#define _DDS_DYNAMICTYPEMEMBERSBYNAME_CH_

typedef std::map< ::TAO::String_Manager, DynamicTypeMember_var> DynamicTypeMembersByName;
...
#if !defined (_DDS_DYNAMICTYPEMEMBERSBYID_CH_)
#define _DDS_DYNAMICTYPEMEMBERSBYID_CH_

typedef std::map< MemberId, DynamicTypeMember_var> DynamicTypeMembersById;
...
public:
  ...
  virtual ::DDS::ReturnCode_t get_all_members_by_name (
    ::DDS::DynamicTypeMembersByName & member) = 0;
  ...
  virtual ::DDS::ReturnCode_t get_all_members (
    ::DDS::DynamicTypeMembersById & member) = 0;
...
typedef TAO_Objref_Var_T<DynamicData> DynamicData_var;
typedef TAO_Objref_Out_T<DynamicData> DynamicData_out;
...
#if !defined (_DDS_DYNAMICDATAFACTORYINTERF__VAR_OUT_CH_)
#define _DDS_DYNAMICDATAFACTORYINTERF__VAR_OUT_CH_

class DynamicDataFactoryInterf;
typedef DynamicDataFactoryInterf *DynamicDataFactoryInterf_ptr;
typedef TAO_Objref_Var_T<DynamicDataFactoryInterf> DynamicDataFactoryInterf_var;
typedef TAO_Objref_Out_T<DynamicDataFactoryInterf> DynamicDataFactoryInterf_out;
...
class OpenDDS_Dcps_Export DynamicDataFactoryInterf
  : public virtual ::CORBA::Object
{
public:
  // TAO_IDL - Generated from
  ...
  typedef DynamicDataFactoryInterf_ptr _ptr_type;
  typedef DynamicDataFactoryInterf_var _var_type;
  typedef DynamicDataFactoryInterf_out _out_type;

  // The static operations.
  static DynamicDataFactoryInterf_ptr _duplicate (DynamicDataFactoryInterf_ptr obj);

  static void _tao_release (DynamicDataFactoryInterf_ptr obj);

  static DynamicDataFactoryInterf_ptr _narrow (::CORBA::Object_ptr obj);
  static DynamicDataFactoryInterf_ptr _unchecked_narrow (::CORBA::Object_ptr obj);
  static DynamicDataFactoryInterf_ptr _nil (void);

  virtual ::DDS::DynamicData_ptr create_data (
    ::DDS::DynamicType_ptr type) = 0;

  virtual ::DDS::ReturnCode_t delete_data (
    ::DDS::DynamicData_ptr data) = 0;
...
protected:
  // Abstract or local interface only.
  DynamicDataFactoryInterf (void);

  

  virtual ~DynamicDataFactoryInterf (void);

private:
  // Private and unimplemented for concrete interfaces.
  ACE_UNIMPLEMENTED_FUNC (DynamicDataFactoryInterf (const DynamicDataFactoryInterf &))
#if defined (ACE_HAS_CPP11)
  ACE_UNIMPLEMENTED_FUNC (DynamicDataFactoryInterf (DynamicDataFactoryInterf &&))
#endif /* ACE_HAS_CPP11 */
  ACE_UNIMPLEMENTED_FUNC (DynamicDataFactoryInterf &operator= (const DynamicDataFactoryInterf &))
#if defined (ACE_HAS_CPP11)
  ACE_UNIMPLEMENTED_FUNC (DynamicDataFactoryInterf &operator= (DynamicDataFactoryInterf &&))
#endif /* ACE_HAS_CPP11 */
};
...
{
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_arg_traits.cpp:299
...
// TAO_IDL - Generated from
// /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/obv_module.cpp:43

namespace OBV_DDS
{
  // TAO_IDL - Generated from
  // /workspaces/testdds/lib/OpenDDS/OpenDDS/ACE_wrappers/TAO/TAO_IDL/be/be_visitor_valuetype/valuetype_obv_ch.cpp:43
...
#if !defined (_DDS_DYNAMICDATAFACTORYINTERF__TRAITS_)
#define _DDS_DYNAMICDATAFACTORYINTERF__TRAITS_

  template<>
  struct OpenDDS_Dcps_Export Objref_Traits< ::DDS::DynamicDataFactoryInterf>
  {
    static ::DDS::DynamicDataFactoryInterf_ptr duplicate (
        ::DDS::DynamicDataFactoryInterf_ptr p);
    static void release (
        ::DDS::DynamicDataFactoryInterf_ptr p);
    static ::DDS::DynamicDataFactoryInterf_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::DDS::DynamicDataFactoryInterf_ptr p,
        TAO_OutputCDR & cdr);
  };
