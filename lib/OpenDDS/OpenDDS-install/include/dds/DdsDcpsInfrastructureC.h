...
#ifndef _TAO_IDL_DDSDCPSINFRASTRUCTUREC_TPP80X_H_
#define _TAO_IDL_DDSDCPSINFRASTRUCTUREC_TPP80X_H_
...
#if !defined (_OPENDDS_DCPS_CONFIGSTORE__VAR_OUT_CH_)
#define _OPENDDS_DCPS_CONFIGSTORE__VAR_OUT_CH_

    class ConfigStore;
    typedef ConfigStore *ConfigStore_ptr;
    typedef TAO_Objref_Var_T<ConfigStore> ConfigStore_var;
    typedef TAO_Objref_Out_T<ConfigStore> ConfigStore_out;
    ...
    class OpenDDS_Dcps_Export ConfigStore
      : public virtual ::CORBA::Object
    {
    public:
      // TAO_IDL - Generated from
      ...
      typedef ConfigStore_ptr _ptr_type;
      typedef ConfigStore_var _var_type;
      typedef ConfigStore_out _out_type;

      // The static operations.
      static ConfigStore_ptr _duplicate (ConfigStore_ptr obj);

      static void _tao_release (ConfigStore_ptr obj);

      static ConfigStore_ptr _narrow (::CORBA::Object_ptr obj);
      static ConfigStore_ptr _unchecked_narrow (::CORBA::Object_ptr obj);
      static ConfigStore_ptr _nil (void);

      virtual ::CORBA::Boolean has (
        const char * key) = 0;

      virtual void set_boolean (
        const char * key,
        ::CORBA::Boolean value) = 0;

      virtual ::CORBA::Boolean get_boolean (
        const char * key,
        ::CORBA::Boolean default_value) = 0;

      virtual void set_int32 (
        const char * key,
        ::CORBA::Long value) = 0;

      virtual ::CORBA::Long get_int32 (
        const char * key,
        ::CORBA::Long default_value) = 0;

      virtual void set_uint32 (
        const char * key,
        ::CORBA::ULong value) = 0;

      virtual ::CORBA::ULong get_uint32 (
        const char * key,
        ::CORBA::ULong default_value) = 0;

      virtual void set_int64 (
        const char * key,
        ::CORBA::LongLong value) = 0;

      virtual ::CORBA::LongLong get_int64 (
        const char * key,
        ::CORBA::LongLong default_value) = 0;

      virtual void set_uint64 (
        const char * key,
        ::CORBA::ULongLong value) = 0;

      virtual ::CORBA::ULongLong get_uint64 (
        const char * key,
        ::CORBA::ULongLong default_value) = 0;

      virtual void set_float64 (
        const char * key,
        ::CORBA::Double value) = 0;

      virtual ::CORBA::Double get_float64 (
        const char * key,
        ::CORBA::Double default_value) = 0;
      ...
      virtual void set_duration (
        const char * key,
        const ::DDS::Duration_t & value) = 0;

      virtual ::DDS::Duration_t get_duration (
        const char * key,
        const ::DDS::Duration_t & default_value) = 0;
    ...
    private:
      // Private and unimplemented for concrete interfaces.
      ACE_UNIMPLEMENTED_FUNC (ConfigStore (const ConfigStore &))
#if defined (ACE_HAS_CPP11)
      ACE_UNIMPLEMENTED_FUNC (ConfigStore (ConfigStore &&))
#endif /* ACE_HAS_CPP11 */
      ACE_UNIMPLEMENTED_FUNC (ConfigStore &operator= (const ConfigStore &))
#if defined (ACE_HAS_CPP11)
      ACE_UNIMPLEMENTED_FUNC (ConfigStore &operator= (ConfigStore &&))
#endif /* ACE_HAS_CPP11 */
    };
...
#if !defined (_OPENDDS_DCPS_CONFIGSTORE__TRAITS_)
#define _OPENDDS_DCPS_CONFIGSTORE__TRAITS_

  template<>
  struct OpenDDS_Dcps_Export Objref_Traits< ::OpenDDS::DCPS::ConfigStore>
  {
    static ::OpenDDS::DCPS::ConfigStore_ptr duplicate (
        ::OpenDDS::DCPS::ConfigStore_ptr p);
    static void release (
        ::OpenDDS::DCPS::ConfigStore_ptr p);
    static ::OpenDDS::DCPS::ConfigStore_ptr nil (void);
    static ::CORBA::Boolean marshal (
        const ::OpenDDS::DCPS::ConfigStore_ptr p,
        TAO_OutputCDR & cdr);
  };
