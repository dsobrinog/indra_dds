...
#ifndef _TAO_IDL_RTPSCORES_PPPP00_H_
#define _TAO_IDL_RTPSCORES_PPPP00_H_
...
#include "dds/OpenDDSConfigWrapperS.h"
#include "RtpsSubmessageKindS.h"
...
namespace TAO
{
  ...
  template<>
  class SArg_Traits< ::OpenDDS::RTPS::UserTagSubmessage>
    : public
        Fixed_Size_SArg_Traits_T<
