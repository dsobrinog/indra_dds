/* -*- C++ -*- */
/* Generated by /workspaces/testdds/lib/OpenDDS/OpenDDS/bin/opendds_idl version 3.34.0-dev (ACE version 6.5.23) running on input file RtpsRpc.idl */
#ifndef OPENDDS_IDL_GENERATED_RTPSRPCTYPESUPPORTIMPL_H_GWVWKH
#define OPENDDS_IDL_GENERATED_RTPSRPCTYPESUPPORTIMPL_H_GWVWKH
...
template <>
OpenDDS_Rtps_Export DDS::DynamicData_ptr get_dynamic_data_adapter< ::DDS::SampleIdentity,  ::DDS::SampleIdentity>(DDS::DynamicType_ptr type, const  ::DDS::SampleIdentity& value);

template <>
OpenDDS_Rtps_Export DDS::DynamicData_ptr get_dynamic_data_adapter< ::DDS::SampleIdentity,  ::DDS::SampleIdentity>(DDS::DynamicType_ptr type,  ::DDS::SampleIdentity& value);

template <>
OpenDDS_Rtps_Export const  ::DDS::SampleIdentity* get_dynamic_data_adapter_value< ::DDS::SampleIdentity,  ::DDS::SampleIdentity>(DDS::DynamicData_ptr dd);
...
class EnumHelper;
OpenDDS_Rtps_Export extern const EnumHelper* gen_DDS_RPC_RemoteExceptionCode_t_helper;
} }
OPENDDS_END_VERSIONED_NAMESPACE_DECL
...
#ifndef OPENDDS_SAFETY_PROFILE
template <>
OpenDDS_Rtps_Export DDS::DynamicData_ptr get_dynamic_data_adapter< ::DDS::RPC::RequestHeader,  ::DDS::RPC::RequestHeader>(DDS::DynamicType_ptr type, const  ::DDS::RPC::RequestHeader& value);

template <>
OpenDDS_Rtps_Export DDS::DynamicData_ptr get_dynamic_data_adapter< ::DDS::RPC::RequestHeader,  ::DDS::RPC::RequestHeader>(DDS::DynamicType_ptr type,  ::DDS::RPC::RequestHeader& value);

template <>
OpenDDS_Rtps_Export const  ::DDS::RPC::RequestHeader* get_dynamic_data_adapter_value< ::DDS::RPC::RequestHeader,  ::DDS::RPC::RequestHeader>(DDS::DynamicData_ptr dd);
...
#ifndef OPENDDS_SAFETY_PROFILE
template <>
OpenDDS_Rtps_Export DDS::DynamicData_ptr get_dynamic_data_adapter< ::DDS::RPC::ReplyHeader,  ::DDS::RPC::ReplyHeader>(DDS::DynamicType_ptr type, const  ::DDS::RPC::ReplyHeader& value);

template <>
OpenDDS_Rtps_Export DDS::DynamicData_ptr get_dynamic_data_adapter< ::DDS::RPC::ReplyHeader,  ::DDS::RPC::ReplyHeader>(DDS::DynamicType_ptr type,  ::DDS::RPC::ReplyHeader& value);

template <>
OpenDDS_Rtps_Export const  ::DDS::RPC::ReplyHeader* get_dynamic_data_adapter_value< ::DDS::RPC::ReplyHeader,  ::DDS::RPC::ReplyHeader>(DDS::DynamicData_ptr dd);
...
/* End MODULE: DDS */
#endif /* OPENDDS_IDL_GENERATED_RTPSRPCTYPESUPPORTIMPL_H_GWVWKH */
