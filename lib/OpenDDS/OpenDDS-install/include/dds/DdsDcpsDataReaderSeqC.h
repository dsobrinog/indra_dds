...
#ifndef _TAO_IDL_DDSDCPSDATAREADERSEQC_0X0DPD_H_
#define _TAO_IDL_DDSDCPSDATAREADERSEQC_0X0DPD_H_
...
#define _DDS_DATAREADERSEQ_CH_
  ...
  class DataReaderSeq;
  typedef ::TAO_VarSeq_Var_T<DataReaderSeq> DataReaderSeq_var;
  typedef ::TAO_Seq_Out_T<DataReaderSeq> DataReaderSeq_out;
