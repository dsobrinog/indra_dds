...
#ifndef OPENDDS_IDL_GENERATED_RELAYC_H_SWTGQD
#define OPENDDS_IDL_GENERATED_RELAYC_H_SWTGQD
#include <array>
#include <cstdint>
#include <map>
#include <string>
...
public:
  ...
  void entityKey(const  ::RtpsRelay::EntityKey_t& val);
  void entityKey( ::RtpsRelay::EntityKey_t&& val);
...
using EntityId_t_out = EntityId_t&; // for tao_idl compatibility
...
public:
  ...
  void guidPrefix(const  ::RtpsRelay::GuidPrefix_t& val);
  void guidPrefix( ::RtpsRelay::GuidPrefix_t&& val);
  ...
  void entityId(const  ::RtpsRelay::EntityId_t& val);
  void entityId( ::RtpsRelay::EntityId_t&& val);
...
using GUID_t_out = GUID_t&; // for tao_idl compatibility
...
namespace RtpsRelay {
enum class AdmitState : uint32_t {
  AS_NORMAL,
  AS_NOT_ADMITTING
};
...
namespace RtpsRelay {
enum class DrainState : uint32_t {
  DS_NORMAL,
  DS_DRAINING
};
...
public:
  ...
  void relay_id(const std::string& val);
  void relay_id(std::string&& val);
  ...
  void partitions(const  ::RtpsRelay::StringSequence& val);
  void partitions( ::RtpsRelay::StringSequence&& val);
...
using RelayPartitions_out = RelayPartitions&; // for tao_idl compatibility
...
public:
  ...
  void address(const std::string& val);
  void address(std::string&& val);
...
using RelayAddress_out = RelayAddress&; // for tao_idl compatibility
...
public:
  ...
  void admit_state( ::RtpsRelay::AdmitState val) { _admit_state = val; }
   ::RtpsRelay::AdmitState admit_state() const { return _admit_state; }
   ::RtpsRelay::AdmitState& admit_state() { return _admit_state; }
   ::RtpsRelay::AdmitState _admit_state{ ::RtpsRelay::AdmitState::AS_NORMAL};

  void admit_state_change(const  ::DDS::Time_t& val);
  void admit_state_change( ::DDS::Time_t&& val);
  const  ::DDS::Time_t& admit_state_change() const { return _admit_state_change; }
   ::DDS::Time_t& admit_state_change() { return _admit_state_change; }
   ::DDS::Time_t _admit_state_change;

  void drain_state( ::RtpsRelay::DrainState val) { _drain_state = val; }
   ::RtpsRelay::DrainState drain_state() const { return _drain_state; }
   ::RtpsRelay::DrainState& drain_state() { return _drain_state; }
   ::RtpsRelay::DrainState _drain_state{ ::RtpsRelay::DrainState::DS_NORMAL};

  void drain_state_change(const  ::DDS::Time_t& val);
  void drain_state_change( ::DDS::Time_t&& val);
  const  ::DDS::Time_t& drain_state_change() const { return _drain_state_change; }
   ::DDS::Time_t& drain_state_change() { return _drain_state_change; }
   ::DDS::Time_t _drain_state_change;
  ...
  void marked_participants(uint32_t val) { _marked_participants = val; }
  uint32_t marked_participants() const { return _marked_participants; }
  uint32_t& marked_participants() { return _marked_participants; }
  uint32_t _marked_participants{};

  RelayStatus() = default;
  RelayStatus(const std::string& relay_id,
    bool admitting,
     ::RtpsRelay::AdmitState admit_state,
    const  ::DDS::Time_t& admit_state_change,
     ::RtpsRelay::DrainState drain_state,
    const  ::DDS::Time_t& drain_state_change,
    uint32_t local_active_participants,
    uint32_t marked_participants);

};

using RelayStatus_out = RelayStatus&; // for tao_idl compatibility
...
public:
  ...
  void guid(const  ::RtpsRelay::GUID_t& val);
  void guid( ::RtpsRelay::GUID_t&& val);
  ...
  void active_ts(const  ::DDS::Time_t& val);
  void active_ts( ::DDS::Time_t&& val);
  ...
  void alive_ts(const  ::DDS::Time_t& val);
  void alive_ts( ::DDS::Time_t&& val);
  const  ::DDS::Time_t& alive_ts() const { return _alive_ts; }
   ::DDS::Time_t& alive_ts() { return _alive_ts; }
   ::DDS::Time_t _alive_ts;

  void user_data(const  ::DDS::UserDataQosPolicy& val);
  void user_data( ::DDS::UserDataQosPolicy&& val);
...
using RelayParticipantStatus_out = RelayParticipantStatus&; // for tao_idl compatibility
...
public:
  ...
  void to_partitions(const  ::RtpsRelay::StringSequence& val);
  void to_partitions( ::RtpsRelay::StringSequence&& val);
  ...
  void to_guids(const  ::RtpsRelay::GuidSequence& val);
  void to_guids( ::RtpsRelay::GuidSequence&& val);
...
using RelayHeader_out = RelayHeader&; // for tao_idl compatibility
...
using Duration_t_out = Duration_t&; // for tao_idl compatibility
...
public:
  ...
  void input_processing_time(const  ::RtpsRelay::Duration_t& val);
  void input_processing_time( ::RtpsRelay::Duration_t&& val);
  ...
  void output_processing_time(const  ::RtpsRelay::Duration_t& val);
  void output_processing_time( ::RtpsRelay::Duration_t&& val);
...
using ProtocolStatistics_out = ProtocolStatistics&; // for tao_idl compatibility
...
public:
  ...
  void interval(const  ::RtpsRelay::Duration_t& val);
  void interval( ::RtpsRelay::Duration_t&& val);
  ...
  void rtps(const  ::RtpsRelay::ProtocolStatistics& val);
  void rtps( ::RtpsRelay::ProtocolStatistics&& val);
  ...
  void stun(const  ::RtpsRelay::ProtocolStatistics& val);
  void stun( ::RtpsRelay::ProtocolStatistics&& val);
  ...
  void max_queue_latency(const  ::RtpsRelay::Duration_t& val);
  void max_queue_latency( ::RtpsRelay::Duration_t&& val);
...
using HandlerStatistics_out = HandlerStatistics&; // for tao_idl compatibility
...
class OpenDDS_RtpsRelayLib_Export ClientPartitionStatistics {
public:

  void slots(uint32_t val) { _slots = val; }
  uint32_t slots() const { return _slots; }
  uint32_t& slots() { return _slots; }
  uint32_t _slots{};

  void free_slots(uint32_t val) { _free_slots = val; }
  uint32_t free_slots() const { return _free_slots; }
  uint32_t& free_slots() { return _free_slots; }
  uint32_t _free_slots{};

  void count(uint32_t val) { _count = val; }
  uint32_t count() const { return _count; }
  uint32_t& count() { return _count; }
  uint32_t _count{};

  void partition_index_cache(uint32_t val) { _partition_index_cache = val; }
  uint32_t partition_index_cache() const { return _partition_index_cache; }
  uint32_t& partition_index_cache() { return _partition_index_cache; }
  uint32_t _partition_index_cache{};

  void partition_index_nodes(uint32_t val) { _partition_index_nodes = val; }
  uint32_t partition_index_nodes() const { return _partition_index_nodes; }
  uint32_t& partition_index_nodes() { return _partition_index_nodes; }
  uint32_t _partition_index_nodes{};

  void guids(uint32_t val) { _guids = val; }
  uint32_t guids() const { return _guids; }
  uint32_t& guids() { return _guids; }
  uint32_t _guids{};

  void guids_cache(uint32_t val) { _guids_cache = val; }
  uint32_t guids_cache() const { return _guids_cache; }
  uint32_t& guids_cache() { return _guids_cache; }
  uint32_t _guids_cache{};

  ClientPartitionStatistics() = default;
  ClientPartitionStatistics(uint32_t slots,
    uint32_t free_slots,
    uint32_t count,
    uint32_t partition_index_cache,
    uint32_t partition_index_nodes,
    uint32_t guids,
    uint32_t guids_cache);

};

using ClientPartitionStatistics_out = ClientPartitionStatistics&; // for tao_idl compatibility

OpenDDS_RtpsRelayLib_Export void swap(ClientPartitionStatistics& lhs, ClientPartitionStatistics& rhs);
...
class OpenDDS_RtpsRelayLib_Export RelayPartitionStatistics {
public:

  void addresses(uint32_t val) { _addresses = val; }
  uint32_t addresses() const { return _addresses; }
  uint32_t& addresses() { return _addresses; }
  uint32_t _addresses{};
  ...
  RelayPartitionStatistics() = default;
  RelayPartitionStatistics(uint32_t addresses,
    uint32_t partition_index_cache,
    uint32_t partition_index_nodes,
    uint32_t slots);
...
using RelayPartitionStatistics_out = RelayPartitionStatistics&; // for tao_idl compatibility

OpenDDS_RtpsRelayLib_Export void swap(RelayPartitionStatistics& lhs, RelayPartitionStatistics& rhs);
...
class OpenDDS_RtpsRelayLib_Export OpenDDSModuleStatistics {
public:

  void id(const std::string& val);
  void id(std::string&& val);
  const std::string& id() const { return _id; }
  std::string& id() { return _id; }
  std::string _id;

  using AnonymousType_stats_map = std::map<std::string, uint64_t>;
  void stats(const AnonymousType_stats_map& val);
  void stats(AnonymousType_stats_map&& val);
  const AnonymousType_stats_map& stats() const { return _stats; }
  AnonymousType_stats_map& stats() { return _stats; }
  AnonymousType_stats_map _stats;

  OpenDDSModuleStatistics() = default;
  OpenDDSModuleStatistics(const std::string& id,
    const AnonymousType_stats_map& stats);

};

using OpenDDSModuleStatistics_out = OpenDDSModuleStatistics&; // for tao_idl compatibility

OpenDDS_RtpsRelayLib_Export void swap(OpenDDSModuleStatistics& lhs, OpenDDSModuleStatistics& rhs);
...
public:
  ...
  void handler_statistics_sub_count(uint32_t val) { _handler_statistics_sub_count = val; }
  uint32_t handler_statistics_sub_count() const { return _handler_statistics_sub_count; }
  uint32_t& handler_statistics_sub_count() { return _handler_statistics_sub_count; }
  uint32_t _handler_statistics_sub_count{};

  void relay_statistics_sub_count(uint32_t val) { _relay_statistics_sub_count = val; }
  uint32_t relay_statistics_sub_count() const { return _relay_statistics_sub_count; }
  uint32_t& relay_statistics_sub_count() { return _relay_statistics_sub_count; }
  uint32_t _relay_statistics_sub_count{};

  void participant_statistics_sub_count(uint32_t val) { _participant_statistics_sub_count = val; }
  uint32_t participant_statistics_sub_count() const { return _participant_statistics_sub_count; }
  uint32_t& participant_statistics_sub_count() { return _participant_statistics_sub_count; }
  uint32_t _participant_statistics_sub_count{};

  void relay_partitions_sub_count(uint32_t val) { _relay_partitions_sub_count = val; }
  uint32_t relay_partitions_sub_count() const { return _relay_partitions_sub_count; }
  uint32_t& relay_partitions_sub_count() { return _relay_partitions_sub_count; }
  uint32_t _relay_partitions_sub_count{};

  void relay_participant_status_sub_count(uint32_t val) { _relay_participant_status_sub_count = val; }
  uint32_t relay_participant_status_sub_count() const { return _relay_participant_status_sub_count; }
  uint32_t& relay_participant_status_sub_count() { return _relay_participant_status_sub_count; }
  uint32_t _relay_participant_status_sub_count{};

  void relay_address_sub_count(uint32_t val) { _relay_address_sub_count = val; }
  uint32_t relay_address_sub_count() const { return _relay_address_sub_count; }
  uint32_t& relay_address_sub_count() { return _relay_address_sub_count; }
  uint32_t _relay_address_sub_count{};

  void relay_status_sub_count(uint32_t val) { _relay_status_sub_count = val; }
  uint32_t relay_status_sub_count() const { return _relay_status_sub_count; }
  uint32_t& relay_status_sub_count() { return _relay_status_sub_count; }
  uint32_t _relay_status_sub_count{};
  ...
  void remote_map_size(uint32_t val) { _remote_map_size = val; }
  uint32_t remote_map_size() const { return _remote_map_size; }
  uint32_t& remote_map_size() { return _remote_map_size; }
  uint32_t _remote_map_size{};

  void max_ips_per_client(uint32_t val) { _max_ips_per_client = val; }
  uint32_t max_ips_per_client() const { return _max_ips_per_client; }
  uint32_t& max_ips_per_client() { return _max_ips_per_client; }
  uint32_t _max_ips_per_client{};

  void total_client_ips(uint32_t val) { _total_client_ips = val; }
  uint32_t total_client_ips() const { return _total_client_ips; }
  uint32_t& total_client_ips() { return _total_client_ips; }
  uint32_t _total_client_ips{};

  void total_client_ports(uint32_t val) { _total_client_ports = val; }
  uint32_t total_client_ports() const { return _total_client_ports; }
  uint32_t& total_client_ports() { return _total_client_ports; }
  uint32_t _total_client_ports{};

  void rejected_address_map_size(uint32_t val) { _rejected_address_map_size = val; }
  uint32_t rejected_address_map_size() const { return _rejected_address_map_size; }
  uint32_t& rejected_address_map_size() { return _rejected_address_map_size; }
  uint32_t _rejected_address_map_size{};

  void deactivation_queue_size(uint32_t val) { _deactivation_queue_size = val; }
  uint32_t deactivation_queue_size() const { return _deactivation_queue_size; }
  uint32_t& deactivation_queue_size() { return _deactivation_queue_size; }
  uint32_t _deactivation_queue_size{};

  void expiration_queue_size(uint32_t val) { _expiration_queue_size = val; }
  uint32_t expiration_queue_size() const { return _expiration_queue_size; }
  uint32_t& expiration_queue_size() { return _expiration_queue_size; }
  uint32_t _expiration_queue_size{};

  void admission_queue_size(uint32_t val) { _admission_queue_size = val; }
  uint32_t admission_queue_size() const { return _admission_queue_size; }
  uint32_t& admission_queue_size() { return _admission_queue_size; }
  uint32_t _admission_queue_size{};

  void transitions_to_admitting(uint32_t val) { _transitions_to_admitting = val; }
  uint32_t transitions_to_admitting() const { return _transitions_to_admitting; }
  uint32_t& transitions_to_admitting() { return _transitions_to_admitting; }
  uint32_t _transitions_to_admitting{};

  void transitions_to_nonadmitting(uint32_t val) { _transitions_to_nonadmitting = val; }
  uint32_t transitions_to_nonadmitting() const { return _transitions_to_nonadmitting; }
  uint32_t& transitions_to_nonadmitting() { return _transitions_to_nonadmitting; }
  uint32_t _transitions_to_nonadmitting{};

  void virtual_memory_kb(uint32_t val) { _virtual_memory_kb = val; }
  uint32_t virtual_memory_kb() const { return _virtual_memory_kb; }
  uint32_t& virtual_memory_kb() { return _virtual_memory_kb; }
  uint32_t _virtual_memory_kb{};

  void client_partitions(const  ::RtpsRelay::ClientPartitionStatistics& val);
  void client_partitions( ::RtpsRelay::ClientPartitionStatistics&& val);
  const  ::RtpsRelay::ClientPartitionStatistics& client_partitions() const { return _client_partitions; }
   ::RtpsRelay::ClientPartitionStatistics& client_partitions() { return _client_partitions; }
   ::RtpsRelay::ClientPartitionStatistics _client_partitions;

  void relay_partitions(const  ::RtpsRelay::RelayPartitionStatistics& val);
  void relay_partitions( ::RtpsRelay::RelayPartitionStatistics&& val);
  const  ::RtpsRelay::RelayPartitionStatistics& relay_partitions() const { return _relay_partitions; }
   ::RtpsRelay::RelayPartitionStatistics& relay_partitions() { return _relay_partitions; }
   ::RtpsRelay::RelayPartitionStatistics _relay_partitions;

  using AnonymousType_opendds_modules_seq = std::vector< ::RtpsRelay::OpenDDSModuleStatistics>;
  void opendds_modules(const AnonymousType_opendds_modules_seq& val);
  void opendds_modules(AnonymousType_opendds_modules_seq&& val);
  const AnonymousType_opendds_modules_seq& opendds_modules() const { return _opendds_modules; }
  AnonymousType_opendds_modules_seq& opendds_modules() { return _opendds_modules; }
  AnonymousType_opendds_modules_seq _opendds_modules;
  ...
  RelayStatistics(const std::string& relay_id,
    ...
    uint32_t handler_statistics_sub_count,
    uint32_t relay_statistics_sub_count,
    uint32_t participant_statistics_sub_count,
    uint32_t relay_partitions_sub_count,
    uint32_t relay_participant_status_sub_count,
    uint32_t relay_address_sub_count,
    uint32_t relay_status_sub_count,
    ...
    uint32_t max_ips_per_client,
    uint32_t total_client_ips,
    uint32_t total_client_ports,
    uint32_t rejected_address_map_size,
    uint32_t deactivation_queue_size,
    uint32_t expiration_queue_size,
    uint32_t admission_queue_size,
    uint32_t transitions_to_admitting,
    uint32_t transitions_to_nonadmitting,
    uint32_t virtual_memory_kb,
    const  ::RtpsRelay::ClientPartitionStatistics& client_partitions,
    const  ::RtpsRelay::RelayPartitionStatistics& relay_partitions,
    const AnonymousType_opendds_modules_seq& opendds_modules);

};

using RelayStatistics_out = RelayStatistics&; // for tao_idl compatibility
...
namespace RtpsRelay {
const std::string RELAY_CONFIG_CONTROL_TOPIC_NAME = "Relay Config Control";
}
...
namespace RtpsRelay {
const std::string RELAY_CONFIG_STATUS_TOPIC_NAME = "Relay Config Status";
}
...
class OpenDDS_RtpsRelayLib_Export RelayConfig {
public:
  ...
  using AnonymousType_config_map = std::map<std::string, std::string>;
  void config(const AnonymousType_config_map& val);
  void config(AnonymousType_config_map&& val);
  const AnonymousType_config_map& config() const { return _config; }
  AnonymousType_config_map& config() { return _config; }
  AnonymousType_config_map _config;

  RelayConfig() = default;
  RelayConfig(const std::string& relay_id,
    const AnonymousType_config_map& config);

};

using RelayConfig_out = RelayConfig&; // for tao_idl compatibility

OpenDDS_RtpsRelayLib_Export void swap(RelayConfig& lhs, RelayConfig& rhs);
...
#endif /* OPENDDS_IDL_GENERATED_RELAYC_H_SWTGQD */
