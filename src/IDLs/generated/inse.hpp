...
/*!
 * @brief This class represents the enumeration EntityClass defined by the user in the IDL file.
 * @ingroup inse
 */
enum class EntityClass : int32_t
{
    None = 0,
    Air,
    MovingGround,
...
/*!
 * @brief This class represents the enumeration EntityTypesAir defined by the user in the IDL file.
 * @ingroup inse
 */
enum class EntityTypesAir : int32_t
{
    Tanker = 1,
    TransportAircraft,
    FighterAircraft,
...
/*!
 * @brief This class represents the enumeration EntityTypesGround defined by the user in the IDL file.
 * @ingroup inse
 */
enum class EntityTypesGround : int32_t
{
    Generic,
    TrafficManAvatar
};
/*!
 * @brief This class represents the enumeration EntityTypesNaval defined by the user in the IDL file.
 * @ingroup inse
 */
enum class EntityTypesNaval : int32_t
{
    Generic = 1,
    Complex
};
/*!
 * @brief This class represents the enumeration EntityTypesNoMovingGround defined by the user in the IDL file.
 * @ingroup inse
 */
enum class EntityTypesNoMovingGround : int32_t
{
    Generic = 1
};
/*!
 * @brief This class represents the enumeration EntityTypesHuman defined by the user in the IDL file.
 * @ingroup inse
 */
enum class EntityTypesHuman : int32_t
{
    Generic = 1,
    Sniper,
    TrafficManAvatar,
...
/*!
 * @brief This class represents the enumeration DamageStatus defined by the user in the IDL file.
 * @ingroup inse
 */
enum class DamageStatus : int32_t
{
    None,
    Light,
    Severed,
...
/*!
 * @brief This class represents the enumeration ActivationMode defined by the user in the IDL file.
 * @ingroup inse
 */
enum class ActivationMode : int32_t
{
    OnCreation = 0,
    SessionTime = 1,
    FlightTime = 2,
...
public:
            ...
            const EntityID& x)
    {
                    ...
                    m_damageStatus = x.m_damageStatus;

                    m_activationMode = x.m_activationMode;
    ...
    /*!
     * @brief This function sets a value in member damageStatus
     * @param _damageStatus New value for member damageStatus
     */
    eProsima_user_DllExport void damageStatus(
            DamageStatus _damageStatus)
    {
        m_damageStatus = _damageStatus;
    }

    /*!
     * @brief This function returns the value of member damageStatus
     * @return Value of member damageStatus
     */
    eProsima_user_DllExport DamageStatus damageStatus() const
    {
        return m_damageStatus;
    }

    /*!
     * @brief This function returns a reference to member damageStatus
     * @return Reference to member damageStatus
     */
    eProsima_user_DllExport DamageStatus& damageStatus()
    {
        return m_damageStatus;
    }
    ...
    /*!
     * @brief This function sets a value in member activationMode
     * @param _activationMode New value for member activationMode
     */
    eProsima_user_DllExport void activationMode(
            ActivationMode _activationMode)
    {
        m_activationMode = _activationMode;
    }

    /*!
     * @brief This function returns the value of member activationMode
     * @return Value of member activationMode
     */
    eProsima_user_DllExport ActivationMode activationMode() const
    {
        return m_activationMode;
    }

    /*!
     * @brief This function returns a reference to member activationMode
     * @return Reference to member activationMode
     */
    eProsima_user_DllExport ActivationMode& activationMode()
    {
        return m_activationMode;
    }
    ...
    /*!
     * @brief This function sets a value in member entityClass
     * @param _entityClass New value for member entityClass
     */
    eProsima_user_DllExport void entityClass(
            EntityClass _entityClass)
    {
        m_entityClass = _entityClass;
    }

    /*!
     * @brief This function returns the value of member entityClass
     * @return Value of member entityClass
     */
    eProsima_user_DllExport EntityClass entityClass() const
    {
        return m_entityClass;
    }

    /*!
     * @brief This function returns a reference to member entityClass
     * @return Reference to member entityClass
     */
    eProsima_user_DllExport EntityClass& entityClass()
    {
        return m_entityClass;
    }
...
private:
    ...
    char m_active{0};
    DamageStatus m_damageStatus{DamageStatus::None};
    ActivationMode m_activationMode{ActivationMode::OnCreation};
    uint32_t m_delayedActivationTime{0};
    char m_manned{0};
    char m_remote{0};
    EntityClass m_entityClass{EntityClass::None};
    char m_entityType{0};
    char m_side{0};
    double m_weight{0.0};
...
/*!
 * @brief This class represents the enumeration MovementTypesAir defined by the user in the IDL file.
 * @ingroup inse
 */
enum class MovementTypesAir : int32_t
{
    Rectilinear,
    Mission,
    Roleplay
...
public:
    ...
    {
                    m_movementMode = x.m_movementMode;
    ...
    {
        return (m_movementMode == x.m_movementMode &&
           m_speed == x.m_speed &&
           m_speed_target == x.m_speed_target &&
           m_geographicHeading == x.m_geographicHeading &&
           m_geographicHeading_target == x.m_geographicHeading_target &&
    ...
    /*!
     * @brief This function sets a value in member movementMode
     * @param _movementMode New value for member movementMode
     */
    eProsima_user_DllExport void movementMode(
            MovementTypesAir _movementMode)
    {
        m_movementMode = _movementMode;
    }

    /*!
     * @brief This function returns the value of member movementMode
     * @return Value of member movementMode
     */
    eProsima_user_DllExport MovementTypesAir movementMode() const
    {
        return m_movementMode;
    }

    /*!
     * @brief This function returns a reference to member movementMode
     * @return Reference to member movementMode
     */
    eProsima_user_DllExport MovementTypesAir& movementMode()
    {
        return m_movementMode;
    }
...
private:
    ...
    MovementTypesAir m_movementMode{MovementTypesAir::Rectilinear};
    float m_speed{0.0};
...
/*!
 * @brief This enumeration represents the Commands bitflags defined by the user in the IDL file.
 * @ingroup inse
 */
enum CommandsBits : uint32_t
{
    None = 0x01ull << 0,
    Add = 0x01ull << 1,
    Delete = 0x01ull << 2,
    ChangeStatus = 0x01ull << 3,
    ChangeSide = 0x01ull << 4,
    ChangeTarget = 0x01ull << 5,
    ChangePos = 0x01ull << 6,
    ChangeAltitude = 0x01ull << 7,
    ChangeMovementType = 0x01ull << 8,
    ChangeIndicatedSpeed = 0x01ull << 9,
    ChangeHeading = 0x01ull << 10,
    ChangeMovementParams = 0x01ull << 11,
    ChangeCommsFlag = 0x01ull << 12,
    ChangeDamage = 0x01ull << 13,
    GCIManoeuvreCmd = 0x01ull << 14,
    ChangeVerticalSpeed = 0x01ull << 15,
    ChangeGroundSpeed = 0x01ull << 16,
    ChangeCurrentFuel = 0x01ull << 17,
    ChangeInfiniteFuel = 0x01ull << 18
};
...
public:
            ...
            const AirEntity& x)
    {
                    ...
                    m_target_entity = x.m_target_entity;

                    m_entity_position = x.m_entity_position;
            ...
            AirEntity&& x) noexcept
    {
        ...
        m_target_entity = std::move(x.m_target_entity);
        m_entity_position = std::move(x.m_entity_position);
    ...
    {
        return (m_commands == x.m_commands &&
           m_entity_id == x.m_entity_id &&
           m_target_entity == x.m_target_entity &&
           m_entity_position == x.m_entity_position &&
           m_entity_attitude == x.m_entity_attitude &&
     ...
     */
    eProsima_user_DllExport const Commands& commands() const
    {
        return m_commands;
    }
     ...
     */
    eProsima_user_DllExport Commands& commands()
    {
        return m_commands;
    }
     ...
     */
    eProsima_user_DllExport const EntityID& entity_id() const
    {
        return m_entity_id;
    }
     ...
     * @return Reference to member entity_id
     */
    eProsima_user_DllExport EntityID& entity_id()
    {
        return m_entity_id;
    }
    ...
    /*!
     * @brief This function copies the value in member target_entity
     * @param _target_entity New value to be copied in member target_entity
     */
    eProsima_user_DllExport void target_entity(
            const Target& _target_entity)
    {
        m_target_entity = _target_entity;
    }

    /*!
     * @brief This function moves the value in member target_entity
     * @param _target_entity New value to be moved in member target_entity
     */
    eProsima_user_DllExport void target_entity(
            Target&& _target_entity)
    {
        m_target_entity = std::move(_target_entity);
    }

    /*!
     * @brief This function returns a constant reference to member target_entity
     * @return Constant reference to member target_entity
     */
    eProsima_user_DllExport const Target& target_entity() const
    {
        return m_target_entity;
    }

    /*!
     * @brief This function returns a reference to member target_entity
     * @return Reference to member target_entity
     */
    eProsima_user_DllExport Target& target_entity()
    {
        return m_target_entity;
    }
    ...
    /*!
     * @brief This function copies the value in member entity_position
     * @param _entity_position New value to be copied in member entity_position
     */
    eProsima_user_DllExport void entity_position(
            const Position& _entity_position)
    {
        m_entity_position = _entity_position;
    }

    /*!
     * @brief This function moves the value in member entity_position
     * @param _entity_position New value to be moved in member entity_position
     */
    eProsima_user_DllExport void entity_position(
            Position&& _entity_position)
    {
        m_entity_position = std::move(_entity_position);
    }

    /*!
     * @brief This function returns a constant reference to member entity_position
     * @return Constant reference to member entity_position
     */
    eProsima_user_DllExport const Position& entity_position() const
    {
        return m_entity_position;
    }

    /*!
     * @brief This function returns a reference to member entity_position
     * @return Reference to member entity_position
     */
    eProsima_user_DllExport Position& entity_position()
    {
        return m_entity_position;
    }
...
private:
    ...
    Commands m_commands{0};
    EntityID m_entity_id;
    Target m_target_entity;
    Position m_entity_position;
