        ...
        size_t& current_alignment)
{
    ...
    size_t calculated_size {calculator.begin_calculate_type_serialized_size(
        ...
        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(8),
                data.damageStatus(), current_alignment);

        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(9),
                data.activationMode(), current_alignment);
        ...
        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(13),
                data.entityClass(), current_alignment);
        ...
        const EntityID& data)
{
    ...
    scdr
        ...
        << eprosima::fastcdr::MemberId(8) << data.damageStatus()
        << eprosima::fastcdr::MemberId(9) << data.activationMode()
        << eprosima::fastcdr::MemberId(10) << data.delayedActivationTime()
        << eprosima::fastcdr::MemberId(11) << data.manned()
        << eprosima::fastcdr::MemberId(12) << data.remote()
        << eprosima::fastcdr::MemberId(13) << data.entityClass()
        << eprosima::fastcdr::MemberId(14) << data.entityType()
        << eprosima::fastcdr::MemberId(15) << data.side()
        << eprosima::fastcdr::MemberId(16) << data.weight()
;
    ...
    cdr.deserialize_type(eprosima::fastcdr::CdrVersion::XCDRv2 == cdr.get_cdr_version() ?
            ...
            [&data](eprosima::fastcdr::Cdr& dcdr, const eprosima::fastcdr::MemberId& mid) -> bool
            {
                ...
                switch (mid.id)
                {
                                        ...
                                        case 8:
                                                dcdr >> data.damageStatus();
                                            break;

                                        case 9:
                                                dcdr >> data.activationMode();
                                            break;
        ...
        const EntityID& data)
{
    ...
    static_cast<void>(data);
                        ...
                        scdr << data.damageStatus();

                        scdr << data.activationMode();
        ...
        size_t& current_alignment)
{
    ...
    size_t calculated_size {calculator.begin_calculate_type_serialized_size(
        ...
        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(0),
                data.movementMode(), current_alignment);
        ...
        const MovementAirEntity& data)
{
    ...
    scdr
        << eprosima::fastcdr::MemberId(0) << data.movementMode()
        << eprosima::fastcdr::MemberId(1) << data.speed()
        << eprosima::fastcdr::MemberId(2) << data.speed_target()
        << eprosima::fastcdr::MemberId(3) << data.geographicHeading()
        << eprosima::fastcdr::MemberId(4) << data.geographicHeading_target()
        << eprosima::fastcdr::MemberId(5) << data.magneticHeading()
        << eprosima::fastcdr::MemberId(6) << data.tmllf()
        << eprosima::fastcdr::MemberId(7) << data.onGround()
        << eprosima::fastcdr::MemberId(8) << data.missionName()
        << eprosima::fastcdr::MemberId(9) << data.indicatedSpeed()
        << eprosima::fastcdr::MemberId(10) << data.indicatedSpeed_target()
        << eprosima::fastcdr::MemberId(11) << data.loadFactor()
        << eprosima::fastcdr::MemberId(12) << data.verticalSpeed()
        << eprosima::fastcdr::MemberId(13) << data.verticalSpeed_target()
        << eprosima::fastcdr::MemberId(14) << data.groundSpeed()
        << eprosima::fastcdr::MemberId(15) << data.groundSpeed_target()
        << eprosima::fastcdr::MemberId(16) << data.throttle()
        << eprosima::fastcdr::MemberId(17) << data.infiniteFuel()
        << eprosima::fastcdr::MemberId(18) << data.initialFuel()
        << eprosima::fastcdr::MemberId(19) << data.currentFuel()
        << eprosima::fastcdr::MemberId(20) << data.fuelConsumption()
;
    scdr.end_serialize_type(current_state);
}
        ...
        size_t& current_alignment)
{
    ...
    size_t calculated_size {calculator.begin_calculate_type_serialized_size(
        ...
        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(0),
                data.commands(), current_alignment);

        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(1),
                data.entity_id(), current_alignment);

        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(2),
                data.target_entity(), current_alignment);

        calculated_size += calculator.calculate_member_serialized_size(eprosima::fastcdr::MemberId(3),
                data.entity_position(), current_alignment);
        ...
        const AirEntity& data)
{
    ...
    scdr
        << eprosima::fastcdr::MemberId(0) << data.commands()
        << eprosima::fastcdr::MemberId(1) << data.entity_id()
        << eprosima::fastcdr::MemberId(2) << data.target_entity()
        << eprosima::fastcdr::MemberId(3) << data.entity_position()
        << eprosima::fastcdr::MemberId(4) << data.entity_attitude()
        << eprosima::fastcdr::MemberId(5) << data.movement()
        << eprosima::fastcdr::MemberId(6) << data.commsActive()
        << eprosima::fastcdr::MemberId(7) << data.formationID()
        << eprosima::fastcdr::MemberId(8) << data.posInt_inseoFormation()
        << eprosima::fastcdr::MemberId(9) << data.isAutomaticTraffic()
;
    scdr.end_serialize_type(current_state);
}
    ...
    cdr.deserialize_type(eprosima::fastcdr::CdrVersion::XCDRv2 == cdr.get_cdr_version() ?
            ...
            [&data](eprosima::fastcdr::Cdr& dcdr, const eprosima::fastcdr::MemberId& mid) -> bool
            {
                ...
                switch (mid.id)
                {
                                        ...
                                        case 2:
                                                dcdr >> data.target_entity();
                                            break;

                                        case 3:
                                                dcdr >> data.entity_position();
                                            break;
        ...
        const AirEntity& data)
{
    ...
    static_cast<void>(data);
                        ...
                        serialize_key(scdr, data.entity_id());

                        serialize_key(scdr, data.target_entity());

                        serialize_key(scdr, data.entity_position());

                        serialize_key(scdr, data.entity_attitude());

                        serialize_key(scdr, data.movement());

                        scdr << data.commsActive();

                        scdr << data.formationID();

                        scdr << data.posInt_inseoFormation();

                        scdr << data.isAutomaticTraffic();
